    ...
    <div class="row flex-wrap justify-content-between align-items-center p-2 p-md-4">
      <div class="col-12 col-md-9 d-flex flex-wrap flex-md-row flex-column mb-3 mb-md-0">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="FoodFair" value="Food Fair">
        ...
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="CostumeParty" value="Costume Party">
          <label class="form-check-label" for="CostumeParty">Costume Party</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="MusicConcert" value="Music Concert">
        ...
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="BookExchange" value="Book Exchange">
